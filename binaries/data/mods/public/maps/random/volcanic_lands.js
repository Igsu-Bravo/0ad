...
for (let size of [
  ...
  createAreas(
    ...
    [new LayeredPainter([tGrassA, tGrassA], [1]), new TileClassPainter(clDirt)],
...
for (let size of [
  ...
  createAreas(
    new ClumpPlacer(size, 0.3, 0.06, 0.5),
    [new TerrainPainter(tGrassB), new TileClassPainter(clDirt)],
    avoidClasses(clForest, 0, clHill, 0, clPlayer, 12),
    scaleByMapSize(20, 80)
  );
...
for (let size of [
  ...
  createAreas(
    new ClumpPlacer(size, 0.3, 0.06, 0.5),
    [new TerrainPainter(tGrassC), new TileClassPainter(clDirt)],
    avoidClasses(clForest, 0, clHill, 0, clPlayer, 12),
    scaleByMapSize(20, 80)
  );
...
placePlayersNomad(
  clPlayer,
  avoidClasses(clForest, 1, clMetal, 4, clRock, 4, clHill, 4)
);

...
g_Gaia.tree1 = "gaia/tree/dead";
g_Gaia.tree2 = "gaia/tree/oak_dead";
g_Gaia.tree3 = "gaia/tree/dead";
g_Gaia.tree4 = "gaia/tree/oak_dead";
g_Gaia.tree5 = "gaia/tree/dead";
...
createArea(new MapBoundsPlacer(), new SmoothingPainter(1, 0.8, 1));
...
var areaVesuv = createArea(
  new RectPlacer(
    new Vector2D(mapCenter.x, fractionToTiles(0.3)),
    new Vector2D(fractionToTiles(0.7), fractionToTiles(0.15))
  ),
  [
    new LayeredPainter(
      [g_Terrains.lavaOuter, g_Terrains.lavaInner, g_Terrains.lavaCenter],
      [scaleByMapSize(1, 3), 2]
    ),
...
createObjectGroups(
  new SimpleGroup(
    g_Decoratives.shipwrecks.map(
      (shipwreck) => new SimpleObject(shipwreck, 0, 1, 1, 20)
    ),
    true,
    g_TileClasses.decorative
  ),
...
createObjectGroups(
  new SimpleGroup(
    g_Decoratives.statues.map((ruin) => new SimpleObject(ruin, 0, 1, 1, 20)),
    true,
    g_TileClasses.decorative
  ),
  0,

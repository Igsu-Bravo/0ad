...
var continentPosition = Vector2D.add(
  mapCenter,
  new Vector2D(0, fractionToTiles(0.38)).rotate(-startAngle)
).round();
createArea(
  new ClumpPlacer(
    diskArea(fractionToTiles(0.4)),
    0.8,
    0.08,
    Infinity,
    continentPosition
...
createAreas(
  ...
  [borderClasses(clLand, 6, 3), avoidClasses(clIsland, 8)],
...
for (let type of types)
  createAreas(
    ...
    [
      avoidClasses(clPlayer, 6, clForest, 10, clHill, 0),
...
for (let size of [
  ...
  createAreas(
    ...
    [
      avoidClasses(clForest, 0, clHill, 0, clDirt, 5, clIsland, 0),
      stayClasses(clLand, 7),
    ],

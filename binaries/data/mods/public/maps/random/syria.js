...
var types = [
  [
    [tMainDirt, tForestFloor2, pForestP],
    [tForestFloor2, pForestP],
  ],
  [
    [tMainDirt, tForestFloor1, pForestT],
    [tForestFloor1, pForestT],
  ],
];
...
group = new SimpleGroup([new SimpleObject(aRock, 1, 3, 0, 1)], true);
createObjectGroupsDeprecated(
  group,
  0,
...
group = new SimpleGroup([new SimpleObject(oLion, 2, 3, 0, 2)], true, clFood);
createObjectGroupsDeprecated(
  group,
  0,
  avoidClasses(clForest, 0, clPlayer, 1, clHill, 1, clFood, 20, clGrass, 2),

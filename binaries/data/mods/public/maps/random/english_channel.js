...
placePlayerBases({
  PlayerPlacement: playerPlacementRiver(
...
paintRiver({
  parallel: false,
  start: new Vector2D(mapBounds.left, mapCenter.y).rotateAround(
    startAngle,
    mapCenter
  ),
  end: new Vector2D(mapBounds.right, mapCenter.y).rotateAround(
    startAngle,
    mapCenter
  ),
...
createHills(
  [tCliff, tCliff, tHill],
  avoidClasses(clPlayer, 20, clHill, 15, clWater, 5),
  clHill,
...
createFood(
  ...
  [3 * numPlayers, 3 * numPlayers, 3 * numPlayers],

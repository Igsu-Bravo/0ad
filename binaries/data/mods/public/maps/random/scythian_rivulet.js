...
const aWorkshopChariot =
  "actor|props/structures/britons/workshop_chariot_01.xml";
...
var [playerIDs, playerPosition] = playerPlacementRiver(
  startAngle,
  fractionToTiles(0.6)
);
...
createObjectGroupsDeprecated(
  new SimpleGroup(
    [new SimpleObject(aReeds, 6, 14, 1, 5)],
    false,
    clShallowsFlora
  ),
  0,
  [new HeightConstraint(-1, 0), avoidClasses(clShallowsFlora, 25)],
...
createDecoration(
  ...
  [scaleByMapSize(2, 7), scaleByMapSize(2, 7)],
  avoidClasses(
    clForest,
    1,
    clPlayer,

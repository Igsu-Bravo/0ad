...
placePlayerBases({
  PlayerPlacement: [
    ...
    playerPlacementLine(
      Math.PI / 2,
      new Vector2D(fractionToTiles(0.76), mapCenter.y),
      fractionToTiles(0.2)
...
createAreas(
  ...
  [new TerrainPainter([tForestFloor, pForest]), new TileClassPainter(clForest)],
  avoidClasses(
    clPlayer,
    20,
    clForest,
...
var stragglerTreeConfig = [
  [
    1,
    avoidClasses(clForest, 0, clWater, 4, clPlayer, 8, clMetal, 6, clHill, 1),
  ],

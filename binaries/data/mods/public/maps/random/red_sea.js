...
g_Terrains.mainTerrain = new Array(4)
  .fill("desert_sand_dunes_50")
  .concat(["desert_sand_dunes_rocks", "desert_dirt_rough_2"]);
...
createObjectGroups(
  ...
  0,
  [stayClasses(g_TileClasses.land, 5), avoidClasses(g_TileClasses.player, 10)],

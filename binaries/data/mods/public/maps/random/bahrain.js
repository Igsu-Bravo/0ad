...
function setLandBiome() {
  g_Terrains.mainTerrain = new Array(3)
    .fill("desert_dirt_rough_2")
    .concat(["desert_dirt_rocks_3", "desert_sand_stones"]);
...
g_Gaia.tree1 = "gaia/tree/cretan_date_palm_tall";
g_Gaia.tree2 = "gaia/tree/cretan_date_palm_short";
g_Gaia.tree3 = "gaia/tree/cretan_date_palm_patch";
...
var areaIsland = createArea(
  new RectPlacer(
    new Vector2D(fractionToTiles(0.4), mapBounds.top),
    new Vector2D(fractionToTiles(0.6), mapCenter.y),
    Infinity
  ),
...
addElements(
  shuffleArray([
    ...
    {
      func: addFish,
      avoid: [g_TileClasses.fish, 18, g_TileClasses.player, 8],
...
for (let i = 0; i < scaleByMapSize(4, 10); ++i)
  createObjectGroupsByAreas(
    randBool()
      ...
      : new SimpleGroup(
          [new SimpleObject(g_Gaia.stoneLarge, 1, 1, 0, 4)],
          true,
          g_TileClasses.rock
        ),
    0,
    [
      avoidClasses(g_TileClasses.rock, 8, g_TileClasses.metal, 8),
      stayClasses(g_TileClasses.island, 4),
    ],
    1,
    40,
    [areaIsland]
...
createObjectGroups(
  new SimpleGroup(
    [
      new SimpleObject(
        "actor|props/special/eyecandy/awning_wood_small.xml",
        1,
        1,
        1,
        7

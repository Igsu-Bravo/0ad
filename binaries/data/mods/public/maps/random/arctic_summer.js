...
createHills(
  ...
  avoidClasses(clPlayer, 35, clForest, 20, clHill, 50, clWater, 2),
  clHill,
...
createBumps(
  avoidClasses(clPlayer, 6, clWater, 2),
...
createFood(
  ...
  [3 * numPlayers, 3 * numPlayers, 3 * numPlayers, 3 * numPlayers],
  avoidClasses(clFood, 20, clHill, 5, clWater, 5),
  clFood
);

...
createForests(
  ...
  [
    avoidClasses(clPlayer, 20, clForest, 17, clRiver, 1),
...
createLayeredPatches(
  ...
  [1, 1],
  [
    avoidClasses(clForest, 0, clDirt, 3, clPlayer, 8, clRiver, 1),
    stayClasses(clLand, 7),
  ],
...
createMines(
  ...
  [
    avoidClasses(clForest, 1, clPlayer, 20, clRock, 10, clRiver, 1),
...
createDecoration(
  ...
  [scaleByMapSize(800, 12800), scaleByMapSize(800, 12800)],
...
createFood(
  ...
  [
    avoidClasses(clForest, 0, clPlayer, 20, clFood, 20, clRiver, 1),
...
createFood(
  ...
  [
    avoidClasses(clForest, 0, clPlayer, 20, clFood, 10, clRiver, 1),
    stayClasses(clLand, 3),
  ],
  clFood
);

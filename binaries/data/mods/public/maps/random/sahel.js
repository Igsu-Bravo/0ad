...
createAreas(
  new ChainPlacer(
    ...
    Math.floor(scaleByMapSize(20, 60)),
    Infinity
  ),
  [
...
group = new SimpleGroup([new SimpleObject(aRock, 1, 3, 0, 3)], true);
createObjectGroupsDeprecated(
  group,
  0,
...
group = new SimpleGroup([new SimpleObject(oZebra, 5, 7, 0, 4)], true, clFood);
createObjectGroupsDeprecated(
  group,
  0,
  avoidClasses(clWater, 1, clPlayer, 20, clFood, 11),
...
group = new SimpleGroup(
  [
    ...
    new SimpleObject(oGiraffeInfant, 0, 2, 0, 4),
  ],
  true,
  clFood
);
...
group = new SimpleGroup(
  [
    ...
    new SimpleObject(oElephantInfant, 0, 2, 0, 4),
  ],
  true,
  clFood
);

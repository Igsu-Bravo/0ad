...
paintRiver({
  ...
  waterFunc: (position, height, riverFraction) => {
    ...
    // Place river bushes
    if (height <= -0.2 || height >= 0.1) return;
...
createAreas(
  ...
  [new TerrainPainter([pForest, tForestFloor]), new TileClassPainter(clForest)],
  avoidClasses(
    clPlayer,
    19,
    clForest,
...
group = new SimpleGroup([new SimpleObject(aDecorativeRock, 1, 3, 0, 1)], true);
createObjectGroupsDeprecated(
  group,
  0,
...
group = new SimpleGroup(
  [new SimpleObject(oFoodTreasure, 1, 1, 0, 2)],
  true,
  clTreasure
);
createObjectGroupsDeprecated(
...
group = new SimpleGroup(
  [new SimpleObject(oWoodTreasure, 1, 1, 0, 2)],
  true,
  clTreasure
);
createObjectGroupsDeprecated(
...
group = new SimpleGroup([new SimpleObject(eObelisk, 1, 1, 0, 1)], true);
createObjectGroupsDeprecated(
  group,
  0,
  [
...
group = new SimpleGroup([new SimpleObject(ePyramid, 1, 1, 0, 1)], true);
createObjectGroupsDeprecated(
  group,
  0,
  [
...
placePlayersNomad(
  clPlayer,
  avoidClasses(clWater, 4, clForest, 1, clMetal, 4, clRock, 4, clFood, 2)
);

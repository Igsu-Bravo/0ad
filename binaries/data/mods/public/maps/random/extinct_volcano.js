...
createBumps(
  avoidClasses(clPlayer, 0, clHill, 0),
  scaleByMapSize(50, 300),
  1,
  10,
  3,
  0,
...
var types = [
  [
    [tGrassB, tGrassA, pForestD],
    [tGrassB, pForestD],
  ],
  [
    [tGrassB, tGrassA, pForestP],
    [tGrassB, pForestP],
  ],
];
...
for (let size of [
  ...
  for (let type of [
    ...
    createAreas(
      ...
      [new LayeredPainter(type, [1]), new TileClassPainter(clGrass)],
...
createObjectGroupsDeprecated(
  ...
  [
    ...
    avoidClasses(clWater, 3, clForest, 1, clPlayer, 0, clRock, 15, clHill, 0),
  ],
  100,
  100
);
...
createDecoration(
  ...
  [scaleByMapSize(15, 200), scaleByMapSize(15, 200), scaleByMapSize(15, 200)],
  [
...
createDecoration(
  ...
  [scaleByMapSize(15, 250), scaleByMapSize(15, 150)],
  avoidClasses(clWater, 0, clForest, 0, clPlayer, 0, clHill, 0)
);
...
createFood(
  ...
  [scaleByMapSize(1, 6) * numPlayers, scaleByMapSize(3, 10) * numPlayers],
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(oBush, 1, 3, 0, 3)], true, clForest),
  0,
  [
    stayClasses(clGrass, 3),
    avoidClasses(clWater, 1, clForest, 1, clPlayer, 0, clMetal, 4, clRock, 4),
  ],
  stragglerTrees
);
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(aRain, 2, 2, 1, 4)], true, clRain),
  0,

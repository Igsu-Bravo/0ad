...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(aRock, 1, 3, 0, 3)], true),
  0,
  avoidClasses(clPlayer, 7, clWater, 1),
  scaleByMapSize(200, 1200),
  1
);
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(oBoar, 1, 2, 0, 4)], true, clFood),
  0,
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(oTiger, 2, 2, 0, 4)], true, clFood),
  0,
  avoidClasses(clWater, 1, clPlayer, 20, clFood, 11),
  scaleByMapSize(4, 12),
  50
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(oCrocodile, 2, 4, 0, 4)], true, clFood),
  0,
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(oRabbit, 5, 6, 0, 4)], true, clFood),
  0,
  avoidClasses(clWater, 1, clPlayer, 20, clFood, 11),
  scaleByMapSize(4, 12),
  50
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(oBerryBush, 5, 7, 0, 4)], true, clFood),
  0,
...
createObjectGroupsDeprecated(
  new SimpleGroup([new SimpleObject(oTree, 1, 7, 0, 3)], true, clForest),
  0,

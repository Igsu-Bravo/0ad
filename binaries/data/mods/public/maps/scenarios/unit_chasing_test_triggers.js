...
var straight_line = function (attacker_first, attacker, target, walk = true) {
  return () => {
    ...
    if (walk) WalkTo(gx, 900, true, chasee);
...
experiments.straight_line_garrison = {
  spawn: straight_line_garrison(
    false,
    "units/athen/infantry_spearman_b",
    "units/mace/siege_ram"
  ),
};
...
cmpTrigger.RegisterTrigger("OnOwnershipChanged", "OwnershipChanged", {
  enabled: true,
});

GameSettings.prototype.Attributes.TeamPlacement = class TeamPlacement extends (
  GameSetting
) {
  init() {
  ...
  toInitAttributes(attribs) {
    if (this.value) attribs.settings.TeamPlacement = this.value;
  }
  ...
  pickRandomItems() {
    ...
    if (this.value !== "random") return false;
...
GameSettings.prototype.Attributes.TeamPlacement.prototype.StartingPositions = [
  {
    ...
    Description: translate(
      "Allied players are grouped and placed with opposing players on one circle spanning the map."
    ),
  },
  {
    Id: "line",
  ...
  },
  {
    ...
    Description: translate(
      "Allied players are grouped, but otherwise placed randomly on the map."
    ),
  },
  {
    Id: "stronghold",
    ...
    Description: translate(
      "Allied players are grouped in one random place of the map."
    ),
  },
];

GameSettings.prototype.Attributes.TriggerScripts = class TriggerScripts extends (
  GameSetting
) {
  init() {
    ...
    this.settings.victoryConditions.watch(
      () => this.updateVictoryScripts(),
      ["active"]
    );
  }
  ...
  toInitAttributes(attribs) {
    ...
    for (let elem of this.map) scripts.add(elem);

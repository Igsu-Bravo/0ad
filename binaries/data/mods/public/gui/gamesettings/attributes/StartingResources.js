 ...
 */
GameSettings.prototype.Attributes.StartingResources = class StartingResources extends (
  GameSetting
) {
  init() {
    this.defaultValue =
      this.getDefaultValue("StartingResources", "Resources") || 300;
  ...
  onMapChange() {
    ...
    if (
      ...
      this.setResources(this.defaultValue);
    else this.setResources(this.getMapSetting("StartingResources"));
  }

GameSettings.prototype.Attributes.Daytime = class Daytime extends GameSetting {
  ...
  toInitAttributes(attribs) {
    if (this.value) attribs.settings.Daytime = this.value;
  }

  fromInitAttributes(attribs) {
    if (!this.getLegacySetting(attribs, "Daytime")) this.setValue(undefined);
    else this.setValue(this.getLegacySetting(attribs, "Daytime"));
  }

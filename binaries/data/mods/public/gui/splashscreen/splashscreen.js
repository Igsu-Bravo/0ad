...
function init(data) {
  Engine.GetGUIObjectByName("mainText").caption = Engine.TranslateLines(
    Engine.ReadFile(g_SplashScreenFile)
  );
...
function closePage() {
  ...
  Engine.ConfigDB_CreateAndWriteValueToFile(
    ...
    Engine.GetFileMTime(g_SplashScreenFile),
    "config/user.cfg"
  );
  Engine.PopGuiPage();
}

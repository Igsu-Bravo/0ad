...
class DiplomacyDialogCeasefireCounter {
  constructor() {
    this.diplomacyCeasefireCounter = Engine.GetGUIObjectByName(
  ...
  update() {
    ...
    this.diplomacyCeasefireCounter.caption = sprintf(
      translateWithContext("ceasefire", this.Caption),
      {
...
DiplomacyDialogCeasefireCounter.prototype.Caption =
  markForTranslationWithContext(
    "ceasefire",
    "Remaining ceasefire time: %(time)s."
  );

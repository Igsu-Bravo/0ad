...
class CivIcon {
  constructor(playerViewControl) {
    ...
    Engine.SetGlobalHotkey(
      "structree",
      "Press",
      this.openPage.bind(this, "page_structree.xml")
    );
    Engine.SetGlobalHotkey(
      "civinfo",
      "Press",
      this.openPage.bind(this, "page_civinfo.xml")
    );
  }
  ...
  openPage(page) {
    ...
    Engine.PushGuiPage(
      page,
      {
        ...
        civ:
          this.dialogSelection.civ ||
          g_Players[Math.max(g_ViewedPlayer, 1)].civ,
...
CivIcon.prototype.Tooltip = markForTranslation(

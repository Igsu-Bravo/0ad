...
class ChatWindow {
  constructor() {
    ...
    this.chatDialogPanelSmallSize = Engine.GetGUIObjectByName(
      "chatDialogPanelSmall"
    ).size;
    this.chatDialogPanelLargeSize = Engine.GetGUIObjectByName(
  ...
  resizeChatWindow() {
    ...
    if (this.isExtended()) {
      ...
      let width =
        this.aspectRatio *
        (chatHistoryTextSize.bottom - chatHistoryTextSize.top);
    ...
    } else this.chatDialogPanel.size = this.chatDialogPanelSmallSize;
  }
}

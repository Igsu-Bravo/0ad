...
DeveloperOverlayCheckboxes.prototype.SelectionEntityState = class {
  constructor(playerViewControl, selection) {
    this.developerOverlayEntityState = new DeveloperOverlayEntityState(
      selection
    );
  }
...
DeveloperOverlayCheckboxes.prototype.ActivateRejoinTest = class {
  ...
  onPress(checked) {
    ...
    box.Caption =
      "Warning: the rejoin test can't be de-activated and is quite slow. Its only purpose is to check for OOS.";
    let self = this;
    box.Buttons = [
      { caption: "Cancel" },
      {

...
TradeDialog.prototype.BarterPanel = class {
  constructor() {
    ...
    this.barterNoMarketsMessage = Engine.GetGUIObjectByName(
      "barterNoMarketsMessage"
    );
  ...
  update() {
    ...
    this.barterHelp.tooltip = sprintf(translate(this.InstructionsTooltip), {
      quantity:
        this.barterButtonManager.getSelectedButton().BarterResourceSellQuantity,
...
TradeDialog.prototype.BarterPanel.getWidthOffset = function () {
  return (
    BarterButton.getWidth(Engine.GetGUIObjectByName("barterResources")) *

...
TraderStatusText.prototype.Components.prototype.LandText = class {
  getText(traderNumber, idleTags) {
    ...
    let message =
      this.IdleLandTraderText[active ? "active" : "no-active"][
        garrisoned ? "garrisoned" : "no-garrisoned"
      ][inactive ? "inactive" : "no-inactive"](inactive);
...
TraderStatusText.prototype.Components.prototype.LandText.prototype.IdleLandTraderText =
  {
    active: {
      garrisoned: {
        "no-inactive": () =>
          translate("%(openingTradingString)s, and %(garrisonedString)s."),
        inactive: () =>
          translate(
      ...
      "no-garrisoned": {
        ...
        inactive: () =>
          translate("%(openingTradingString)s, and %(inactiveString)s."),
      },
    },
    "no-active": {
      garrisoned: {
        ...
        inactive: () =>
          translate("%(openingGarrisonedString)s, and %(inactiveString)s."),
      },
      "no-garrisoned": {
        inactive: (inactive) =>
          translatePlural(

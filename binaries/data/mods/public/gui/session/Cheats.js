...
class Cheats {
  constructor() {
    ...
    for (let fileName of Engine.ListDirectoryFiles(
      ...
      else this.cheats[cheat.Name] = cheat.Data;
    }
  }
  ...
  executeCheat(text) {
    ...
    if (cheat.isNumeric) parameter = +parameter;

 ...
 */
QuitConfirmationMenu.prototype.MultiplayerHost = class extends (
  QuitConfirmation
) {
  enabled() {
...
QuitConfirmationMenu.prototype.MultiplayerHost.prototype.Caption = translate(
 ...
 */
QuitConfirmationMenu.prototype.MultiplayerClient = class extends (
  QuitConfirmation
) {
  enabled() {
    return g_IsNetworked && !g_IsController && !g_IsObserver;
...
ReturnQuestion.prototype.Caption = translate(

...
function getBuiltByText(template) {
  ...
  return template.builtByListOfNames
    ? buildListText(translate("Built by:"), template.builtByListOfNames)
    : "";
}
...
function getTrainedByText(template) {
  ...
  return template.trainedByListOfNames
    ? buildListText(translate("Trained by:"), template.trainedByListOfNames)
    : "";
}
...
function getResearchedByText(template) {
  ...
  return template.researchedByListOfNames
    ? buildListText(
        translate("Researched at:"),
        template.researchedByListOfNames
      )
    : "";
}
...
function getBuildText(template) {
  ...
  return template.buildListOfNames
    ? buildListText(translate("Builds:"), template.buildListOfNames)
    : "";
}
...
function getResearchText(template) {
  ...
  return template.researchListOfNames
    ? buildListText(translate("Researches:"), template.researchListOfNames)
    : "";
}
...
function getTrainText(template) {
  ...
  return template.trainListOfNames
    ? buildListText(translate("Trains:"), template.trainListOfNames)
    : "";
}
...
function getUpgradeText(template) {
  ...
  return template.upgradeListOfNames

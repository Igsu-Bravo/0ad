...
StructuresSubsection.prototype.HeadingCaption = (count) =>
  translatePlural("Specific Structure", "Specific Structures", count);

StructuresSubsection.prototype.IdentifyingClassList = ["CivSpecific Structure"];

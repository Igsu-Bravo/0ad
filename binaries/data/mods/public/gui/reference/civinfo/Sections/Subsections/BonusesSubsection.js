class BonusesSubsection extends Subsection {
  ...
  update(civCode, civInfo) {
    ...
    Array.prototype.push.apply(
      civBonuses,
      this.getAuraCaptions(player.civbonuses)
    );
    ...
    let teamBonuses = this.getAuraCaptions(player.teambonuses, civCode);
    teamBonuses.unshift(
      this.page.formatHeading(
    ...
    this.CivBonuses.caption =
      civBonuses.join("\n") + "\n\n" + teamBonuses.join("\n");
  }
}

BonusesSubsection.prototype.HeadingCivBonusCaption = (count) =>
  translatePlural("Civilization Bonus", "Civilization Bonuses", count);

BonusesSubsection.prototype.HeadingTeamBonusCaption = (count) =>
  translatePlural("Team Bonus", "Team Bonuses", count);

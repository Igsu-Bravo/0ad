class Emblem {
  ...
  setCiv(civCode, civData) {
    let template = this.page.TemplateParser.getEntity(
      this.CatafalqueTemplateMethod(civCode),
      civCode
    );
...
Emblem.prototype.CatafalqueTemplateMethod = (civCode) =>
  "units/" + civCode + "/catafalque";

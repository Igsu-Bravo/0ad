class AIDescription {
  ...
  render() {
    ...
    if (!!AI) AI = g_Settings.AIDescriptions.find((desc) => desc.id == AI.bot);
    this.aiDescription.caption = AI
      ? AI.data.description
      : this.NoAIDescription;
  }
}

AIDescription.prototype.NoAIDescription = translate(
  "AI will be disabled for this player."
);

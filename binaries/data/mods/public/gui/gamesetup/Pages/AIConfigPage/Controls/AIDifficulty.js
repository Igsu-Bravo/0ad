AIGameSettingControls.AIDifficulty = class extends (
  AIGameSettingControlDropdown
) {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    this.setHidden(!ai);
    if (!!ai) this.setSelectedValue(ai.difficulty);
  }

  onSelectionChange(itemIdx) {
    g_GameSettings.playerAI.setDifficulty(
      this.playerIndex,

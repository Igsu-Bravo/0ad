...
GameSettingControls.Cheats = class Cheats extends GameSettingControlCheckbox {
  ...
  onLoad() {
    if (!g_IsNetworked) g_GameSettings.cheats.setEnabled(true);
    this.render();
  }
...
GameSettingControls.Cheats.prototype.TitleCaption = translate("Cheats");

GameSettingControls.Cheats.prototype.Tooltip = translate(
  "Toggle the usability of cheats."
);

GameSettingControls.GameSpeed = class GameSpeed extends (
  ...
  render() {
    ...
    let values = prepareForDropdown(
      g_Settings.GameSpeeds.filter(
        (speed) => !speed.FastForward || allowFastForward
      )
    );
    ...
    if (resetToDefault)
      g_GameSettings.gameSpeed.setSpeed(
        this.dropdown.list_data[values.Default]
      );
  }
...
GameSettingControls.GameSpeed.prototype.TitleCaption = translate("Game Speed");

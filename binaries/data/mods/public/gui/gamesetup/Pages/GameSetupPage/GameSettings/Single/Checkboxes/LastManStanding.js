GameSettingControls.LastManStanding = class LastManStanding extends (
  GameSettingControlCheckbox
) {
  constructor(...args) {
    super(...args);
    g_GameSettings.lastManStanding.watch(
      () => this.render(),
      ["enabled", "available"]
    );
...
GameSettingControls.LastManStanding.prototype.Tooltip = translate(
  "Toggle whether the last remaining player or the last remaining set of allies wins."
);

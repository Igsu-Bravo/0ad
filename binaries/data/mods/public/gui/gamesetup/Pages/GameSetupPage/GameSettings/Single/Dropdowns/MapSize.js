GameSettingControls.MapSize = class MapSize extends GameSettingControlDropdown {
  ...
  onHoverChange() {
    this.dropdown.tooltip =
      g_MapSizes.Tooltip[this.dropdown.hovered] || this.Tooltip;
  }
...
GameSettingControls.MapSize.prototype.TitleCaption = translate("Map Size");

GameSettingControls.MapSize.prototype.Tooltip = translate(

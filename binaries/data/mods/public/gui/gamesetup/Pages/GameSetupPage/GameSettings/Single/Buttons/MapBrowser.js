GameSettingControls.MapBrowser = class MapBrowser extends (
  GameSettingControlButton
) {
  constructor(...args) {
    super(...args);
...
GameSettingControls.MapBrowser.prototype.Caption = translate("Browse Maps");

GameSettingControls.MapBrowser.prototype.HotkeyTooltip = translate(
  "Press %(hotkey)s to view the list of available maps."
);

PlayerSettingControls.PlayerFrame = class PlayerFrame extends (
  GameSettingControl
) {
  constructor(...args) {
    super(...args);

    this.playerFrame = Engine.GetGUIObjectByName(
      "playerFrame[" + this.playerIndex + "]"
    );

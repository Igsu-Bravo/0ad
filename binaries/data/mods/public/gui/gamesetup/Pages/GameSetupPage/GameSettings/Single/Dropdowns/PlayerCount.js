GameSettingControls.PlayerCount = class PlayerCount extends (
  GameSettingControlDropdown
) {
  constructor(...args) {
    super(...args);

    this.values = Array.from(new Array(g_MaxPlayers), (v, i) => i + 1);
...
GameSettingControls.PlayerCount.prototype.Tooltip = translate(

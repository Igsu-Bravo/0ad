GameSettingControls.Biome = class Biome extends GameSettingControlDropdown {
  ...
  onHoverChange() {
    if (!this.dropdown.list_data[this.dropdown.hovered])
      ...
      this.dropdown.tooltip =
        g_GameSettings.biome.biomeData[
...
GameSettingControls.Biome.prototype.TitleCaption = translate("Biome");

GameSettingControls.Biome.prototype.RandomBiomeId = "random";

GameSettingControls.Biome.prototype.Tooltip = translate(
  "Select the flora and fauna."
);

GameSettingControls.Biome.prototype.RandomBiome = translateWithContext(
  "biome",
  "Random"
);

GameSettingControls.Biome.prototype.RandomDescription = translate(

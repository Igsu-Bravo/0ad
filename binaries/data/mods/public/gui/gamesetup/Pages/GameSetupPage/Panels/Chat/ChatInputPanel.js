class ChatInputPanel {
  ...
  onPress() {
    ...
    if (!executeNetworkCommand(text)) Engine.SendNetworkChat(text);

    this.chatInput.focus();
  }
}

ChatInputPanel.prototype.Tooltip = translate(
  "Press %(hotkey)s to autocomplete player names or settings."
);

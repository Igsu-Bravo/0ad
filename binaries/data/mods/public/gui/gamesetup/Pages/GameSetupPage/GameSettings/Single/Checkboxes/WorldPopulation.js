GameSettingControls.WorldPopulation = class WorldPopulation extends (
...
GameSettingControls.WorldPopulation.prototype.Tooltip = translate(
  "When checked the Population Cap will be evenly distributed over all living players."
);

...
class GameSettingControlCheckbox extends GameSettingControl {
  ...
  setChecked(checked) {
    if (this.previousSelectedValue == checked) return;
  ...
  onPressSuper() {
    if (!this.isInGuiUpdate) this.onPress(this.checkbox.checked);
  }
}

GameSettingControlCheckbox.prototype.Checked = translate("Yes");

GameSettingControlCheckbox.prototype.Unchecked = translate("No");

GameSettingControls.WonderDuration = class WonderDuration extends (
  ...
  render() {
    ...
    if (g_GameSettings.wonder.available) {
      ...
      this.setSelectedValue(
        ...
        value == 0
          ? this.InstantVictory
          : sprintf(this.CaptionVictoryTime(value), this.sprintfValue)
      );
    }
  }
...
GameSettingControls.WonderDuration.prototype.Tooltip = translate(
  "Minutes until the player has achieved Wonder Victory"
);

GameSettingControls.WonderDuration.prototype.CaptionVictoryTime = (min) =>

GameSettingControls.Landscape = class Landscape extends (
  ...
  render() {
    ...
    if (!g_GameSettings.landscape.data) return;

    let randomItems = [
      {
        Id: "random",
        Name: setStringTags(
          translateWithContext("landscape selection", "Random"),
          this.RandomItemTags
        ),
...
GameSettingControls.Landscape.prototype.TitleCaption = translate("Landscape");

GameSettingControls.Landscape.prototype.Tooltip = translate(
  "Select one of the landscapes of this map."
);

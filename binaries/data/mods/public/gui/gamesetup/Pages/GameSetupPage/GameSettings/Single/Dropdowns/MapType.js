...
GameSettingControls.MapType = class MapType extends GameSettingControlDropdown {
  ...
  onHoverChange() {
    this.dropdown.tooltip =
      g_MapTypes.Description[this.dropdown.hovered] || this.Tooltip;
  }
...
GameSettingControls.MapType.prototype.TitleCaption = translate("Map Type");

GameSettingControls.MapType.prototype.Tooltip = translate("Select a map type.");

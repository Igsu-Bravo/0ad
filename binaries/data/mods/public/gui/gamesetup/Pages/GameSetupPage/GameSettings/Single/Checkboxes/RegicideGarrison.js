GameSettingControls.RegicideGarrison = class RegicideGarrison extends (
  GameSettingControlCheckbox
) {
  constructor(...args) {
    super(...args);

    g_GameSettings.regicideGarrison.watch(
      () => this.render(),
      ["enabled", "available"]
    );
...
GameSettingControls.RegicideGarrison.prototype.Tooltip = translate(
  "Toggle whether heroes can be garrisoned."
);

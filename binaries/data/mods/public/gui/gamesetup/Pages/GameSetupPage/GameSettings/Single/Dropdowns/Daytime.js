GameSettingControls.Daytime = class Daytime extends GameSettingControlDropdown {
  ...
  render() {
    ...
    if (!g_GameSettings.daytime.data) return;
...
GameSettingControls.Daytime.prototype.TitleCaption = translate("Daytime");

GameSettingControls.Daytime.prototype.Tooltip = translate(
  "Select whether the match takes place at daylight or night."
);

GameSettingControls.Daytime.prototype.RandomTitle = translateWithContext(
  "daytime selection",
  "Random"
);

GameSettingControls.Daytime.prototype.RandomDescription = translateWithContext(
  "daytime selection",
  "Randomly pick a time of the day."
);

...
class LeaderboardPage {
  constructor(xmppMessages) {
    ...
    Engine.GetGUIObjectByName("leaderboardUpdateButton").onPress =
      this.onPressUpdate.bind(this);
    Engine.GetGUIObjectByName("leaderboardPageBack").onPress =
      this.onPressClose.bind(this);
  }
  ...
  openPage() {
    ...
    for (let handler of this.openPageHandlers) handler(playerName);
  }

...
class JoinButton {
  ...
  onPress() {
    ...
    if (!game.isCompatible)
      ...
      messageBox(
        ...
        200,
        translate(
          "The game has already started. Do you want to join as observer?"
        ),
   ...
   */
  joinSelectedGame() {
    if (this.joinButton.hidden) return;
  ...
  getRejoinRating(game) {
    for (let player of game.players) {
      ...
      if (playerNickRating.nick == g_Nickname) return playerNickRating.rating;
    }

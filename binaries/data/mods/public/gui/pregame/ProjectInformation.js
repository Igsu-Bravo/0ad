...
var g_ProjectInformation = {
  ...
  productDescription: {
    caption:
      setStringTags(translate("Alpha XXV: Yaunā"), { font: "sans-bold-16" }) +
      "\n\n" +
      translate(
...
var g_CommunityButtons = [
  ...
  },
  {
    ...
    tooltip: translate(
      "Click to open the 0 A.D. IRC chat in your browser (#0ad on webchat.quakenet.org). It is run by volunteers who do all sorts of tasks, it may take a while to get your question answered. Alternatively, you can use the forum (see Website)."
    ),
  ...
  },
  {
    ...
    tooltip: translate(
      "Click to visit the Frequently Asked Questions page in your browser."
    ),

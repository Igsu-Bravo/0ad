var g_MainMenuItems = [
  {
    ...
    submenu: [
      ...
      },
      {
        ...
        tooltip: colorizeHotkey(
          translate(
            "%(hotkey)s: Learn about the civilizations featured in 0 A.D."
          ),
          "civinfo"
        ),
        hotkey: "civinfo",
      ...
      },
      {
        ...
        tooltip: translate(
          "Compare the bonuses of catafalques featured in 0 A.D."
        ),
        onPress: () => {
  ...
  },
  {
    ...
    submenu: [
      ...
      },
      {
        caption: translate("Continue Campaign"),
        tooltip: translate(
          "Relive history through historical military campaigns."
        ),
        onPress: () => {
          try {
            Engine.SwitchGuiPage(CampaignRun.getCurrentRun().getMenuPath());
    ...
    submenu: [
      ...
      },
      {
        ...
        tooltip:
          colorizeHotkey(
            translate(
              "%(hotkey)s: Launch the multiplayer lobby to join and host publicly visible games and chat with other players."
            ),
            "lobby"
          ) +
          (Engine.StartXmppClient
            ? ""
            : translate("Launch the multiplayer lobby. \\[DISABLED BY BUILD]")),
    ...
    submenu: [
      {
        ...
        onPress: () => {
          Engine.PushGuiPage("page_options.xml", {}, fireConfigChangeHandlers);
        },
      },
      {
      ...
      },
      {
        ...
        tooltip: translate(
          "Show the Welcome Screen again. Useful if you hid it by mistake."
        ),
        onPress: () => {
    ...
    onPress: () => {
      if (Engine.AtlasIsAvailable())
        messageBox(
          ...
          200,
          translate(
            "Are you sure you want to quit 0 A.D. and open the Scenario Editor?"
          ),
        ...
        messageBox(
          ...
          200,
          translate(
            "The scenario editor is not available or failed to load. See the game logs for additional information."
          ),
          translate("Error")
        );
    },

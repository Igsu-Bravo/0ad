...
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { entities: [{ class: "Village", number: 5, check: "count" }] },
]);

// Entity Requirement: Count of entities matching given class
template.requirements = { entity: { class: "Village", numberOfTypes: 5 } };
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { entities: [{ class: "Village", number: 5, check: "variants" }] },
]);
...
template.requirements = {
  all: [{ tech: "tech_A" }, { tech: "tech_B" }, { tech: "tech_C" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
...
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  {
    entities: [
      { class: "class_A", number: 5, check: "count" },
      { class: "class_B", number: 5, check: "count" },
      { class: "class_C", number: 5, check: "count" },
    ],
  },
]);
...
template.requirements = {
  all: [
    { tech: "tech_A" },
    { entity: { class: "class_B", number: 5, check: "count" } },
  ],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  {
...
// Multiple `civ`s
template.requirements = {
  all: [{ civ: "civ_A" }, { civ: "civ_B" }, { civ: "civ_C" }],
};
...
// Multiple `notciv`s
template.requirements = {
  all: [{ notciv: "civ_A" }, { notciv: "civ_B" }, { notciv: "civ_C" }],
};
...
template.requirements = {
  all: [{ civ: "athen" }, { entity: { class: "Village", number: 5 } }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { entities: [{ class: "Village", number: 5, check: "count" }] },
]);
...
template.requirements = {
  all: [{ civ: "athen" }, { entity: { class: "Village", numberOfTypes: 5 } }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { entities: [{ class: "Village", number: 5, check: "variants" }] },
]);
...
template.requirements = {
  all: [{ notciv: "athen" }, { tech: "expected_tech" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "spart"), [
  { techs: ["expected_tech"] },
...
template.requirements = {
  all: [{ notciv: "athen" }, { entity: { class: "Village", number: 5 } }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "spart"), [
  { entities: [{ class: "Village", number: 5, check: "count" }] },
...
// Multiple techs
template.requirements = {
  any: [{ tech: "tech_A" }, { tech: "tech_B" }, { tech: "tech_C" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { techs: ["tech_A"] },
  { techs: ["tech_B"] },
...
// Multiple `civ`s
template.requirements = {
  any: [{ civ: "civ_A" }, { civ: "civ_B" }, { civ: "civ_C" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civ_A"), []);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civ_B"), []);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civ_C"), []);
...
// Multiple `notciv`s
template.requirements = {
  any: [{ notciv: "civ_A" }, { notciv: "civ_B" }, { notciv: "civ_C" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civ_A"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civ_B"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civ_C"), false);
...
template.requirements = {
  any: [{ civ: "athen" }, { entity: { class: "Village", number: 5 } }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), []);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "spart"), [
  { entities: [{ class: "Village", number: 5, check: "count" }] },
...
template.requirements = {
  any: [{ civ: "athen" }, { entity: { class: "Village", numberOfTypes: 5 } }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), []);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "spart"), [
  { entities: [{ class: "Village", number: 5, check: "variants" }] },
...
// A `notciv` or a tech
template.requirements = {
  any: [{ notciv: "athen" }, { tech: "expected_tech" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "spart"), [
  { techs: ["expected_tech"] },
...
template.requirements = {
  any: [{ notciv: "athen" }, { entity: { class: "Village", number: 5 } }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "spart"), [
  { entities: [{ class: "Village", number: 5, check: "count" }] },
...
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { techs: ["tech_A", "tech_B", "tech_C", "tech_D"] },
]);
...
template.requirements = {
  all: [
    ...
    {
      all: [
        { entity: { class: "class_B", numberOfTypes: 5 } },
        { tech: "tech_B" },
      ],
    },
  ],
...
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  {
    ...
    entities: [
      { class: "class_A", number: 5, check: "count" },
      { class: "class_B", number: 5, check: "variants" },
    ],
  },
]);
...
template.requirements = {
  all: [{ all: [{ notciv: "athen" }, { notciv: "spart" }] }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
...
template.requirements = {
  all: [{ all: [{ tech: "tech_A" }, { civ: "maur" }] }, { tech: "tech_B" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { techs: ["tech_B"] },
]);
...
template.requirements = {
  all: [{ all: [{ tech: "tech_A" }, { notciv: "maur" }] }, { tech: "tech_B" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), [
  { techs: ["tech_A", "tech_B"] },
]);
...
// Two `notciv`s, without and with a tech
template.requirements = {
  all: [{ any: [{ notciv: "athen" }, { notciv: "spart" }] }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "maur"), []);
...
// Two `notciv`s, without and with a tech
template.requirements = {
  any: [{ all: [{ notciv: "athen" }, { notciv: "spart" }] }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "maur"), []);
...
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civA"), [
  { techs: ["tech1"] },
  { techs: ["tech2"] },
]);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civB"), [
  { techs: ["tech2"] },
]);

template.requirements = {
  any: [{ all: [{ notciv: "civA" }, { tech: "tech1" }] }, { tech: "tech2" }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civA"), [
  { techs: ["tech2"] },
]);
...
// Two `notciv`s, without and with a tech
template.requirements = {
  any: [{ any: [{ notciv: "athen" }, { notciv: "spart" }] }],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "athen"), false);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "maur"), []);
...
template.requirements = {
  any: [
    { all: [{ civ: "civA" }, { tech: "tech1" }] },
    { all: [{ any: [{ civ: "civB" }, { civ: "civC" }] }, { tech: "tech2" }] },
  ],
};
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civA"), [
  { techs: ["tech1"] },
]);
TS_ASSERT_UNEVAL_EQUALS(DeriveTechnologyRequirements(template, "civC"), [
  { techs: ["tech2"] },
]);

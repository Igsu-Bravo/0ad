...
Identity.prototype.Init = function () {
  ...
  else this.phenotype = "default";

  this.controllable = this.template.Controllable
    ? this.template.Controllable == "true"
    : true;
};
...
IdentityMirage.prototype.GetClassesList = function () {
  return this.classes;
};

...
Repairable.prototype.AddBuilders = function (builders) {
  for (let builder of builders) this.AddBuilder(builder);
};
...
Repairable.prototype.AddBuilder = function (builderEnt) {
  ...
  this.builders.set(
    builderEnt,
    Engine.QueryInterface(builderEnt, IID_Builder).GetRate()
  );
...
Repairable.prototype.OnEntityRenamed = function (msg) {
  ...
  if (cmpRepairableNew) cmpRepairableNew.AddBuilders(this.GetBuilders());
};
...
RepairableMirage.prototype.GetNumBuilders = function () {
  return this.numBuilders;
};
RepairableMirage.prototype.GetBuildTime = function () {
  return this.buildTime;
};
RepairableMirage.prototype.IsRepairable = function () {
  return !this.unrepairable;
};

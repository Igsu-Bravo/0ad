...
function isNegativeZero(z) {
  return z === 0 && 1 / z === -Infinity;
}
function isPositiveZero(z) {
  return z === 0 && 1 / z === Infinity;
}
...
TS_ASSERT_EQUALS(Math.square(1e155), Infinity);
...
TS_ASSERT_UNEVAL_EQUALS(
  Math.euclidDistance2D(1e140, 1e140, 0, 0),
  1.414213562373095e140
);

...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "ResourceTrickle/Rates/food") return currentValue + 1;
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "ResourceTrickle/Interval") return currentValue + 200;
  if (valueName == "ResourceTrickle/Rates/food") return currentValue + 1;
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "ResourceTrickle/Interval") return currentValue - 100;
  if (valueName == "ResourceTrickle/Rates/food") return currentValue + 1;
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "ResourceTrickle/Interval") return currentValue - 201;
  if (valueName == "ResourceTrickle/Rates/food") return currentValue + 1;

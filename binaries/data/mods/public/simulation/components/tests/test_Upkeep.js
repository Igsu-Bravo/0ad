...
let ApplyValueModificationsToEntity = (valueName, currentValue, entity) =>
  currentValue;
...
TS_ASSERT_UNEVAL_EQUALS(cmpPlayer.GetResourceCounts(), {
  food: 300,
  metal: 300,
});
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "Upkeep/Rates/food") return currentValue + 1;
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "Upkeep/Interval") return currentValue + 200;
  if (valueName == "Upkeep/Rates/food") return currentValue + 1;
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "Upkeep/Interval") return currentValue - 100;
  if (valueName == "Upkeep/Rates/food") return currentValue + 1;
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "Upkeep/Interval") return currentValue - 201;
  if (valueName == "Upkeep/Rates/food") return currentValue + 1;
...
ApplyValueModificationsToEntity = (valueName, currentValue, entity) => {
  if (valueName == "Upkeep/Rates/food") return currentValue + 1;
  if (valueName == "Upkeep/Rates/metal") return currentValue + 2;

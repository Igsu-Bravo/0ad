...
TS_ASSERT_EQUALS(
  cmpIdentity.CanUseFormation("special/formations/skirmish"),
  false
);
...
cmpIdentity = ConstructComponent(6, "Identity", {
  ...
  History:
    "Iberians, especially the Lusitanians, were good at" +
...
TS_ASSERT_EQUALS(
  ...
  "units/iber/infantry_javelineer_b"
);
TS_ASSERT_EQUALS(cmpIdentity.GetGenericName(), "Iberian Skirmisher");
...
TS_ASSERT_UNEVAL_EQUALS(cmpIdentity.GetPossiblePhenotypes(), [
  "First",
  "Second",
]);

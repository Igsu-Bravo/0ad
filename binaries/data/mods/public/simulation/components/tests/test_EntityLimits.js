...
// Test getters
TS_ASSERT_UNEVAL_EQUALS(cmpEntityLimits.GetCounts(), {
  Tower: 0,
  Wonder: 0,
  Hero: 0,
  Champion: 0,
});
TS_ASSERT_UNEVAL_EQUALS(cmpEntityLimits.GetLimits(), {
  Tower: 5,
  Wonder: 1,
  Hero: 2,
  Champion: 1,
});
TS_ASSERT_UNEVAL_EQUALS(cmpEntityLimits.GetLimitChangers(), {
  Tower: { Monument: 1 },
});
...
cmpEntityLimits.OnGlobalOwnershipChanged({
  entity: 60,
  from: INVALID_PLAYER,
  to: 1,
});

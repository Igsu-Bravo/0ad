...
var API3 = (function (m) {
  ...
  m.Technology.prototype.name = function (civ) {
    if (civ === undefined) return this._template.genericName;

    if (
      this._template.specificName === undefined ||
      this._template.specificName[civ] === undefined
    )
      return undefined;
  ...
  m.Technology.prototype.getPairedTechs = function () {
    if (!this._definesPair) return undefined;
  ...
  m.Technology.prototype.pair = function () {
    if (!this._isPair) return undefined;
  ...
  m.Technology.prototype.cost = function (productionQueue) {
    if (!this._template.cost) return undefined;
    let cost = {};
